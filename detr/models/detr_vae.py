        ...
        if backbones is not None:
            ...
            for backbone in backbones:
                ...
                down_proj = nn.Sequential(
                    nn.Conv2d(backbone.num_channels, 128, kernel_size=8),
...
def build(args):
    ...
    print("[INFO] num queries : ", args.num_queries)
    print("[INFO] backbone : ", backbones )
    print("[INFO] transformer : ", transformer)
    print("[INFO] encoder : ", encoder)
