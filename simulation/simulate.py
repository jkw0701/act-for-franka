...
#import progressbar
class Simulator:
    def __init__(self, file_path='actions0401.csv'):
    ...
    def simulate(self):
        with Progress() as progress:
            ...
            for index, row in self.data.iterrows():
                ...
                if index % 25 == 0:
                    ...
                    self.franka.move_to_joint_position_with_spline(joint_positions)
        ...
        #self.franka.move_to_joint_position_with_spline(solution)
        #self.franka.initial_pose()
